...
int main()
{
    ...
    "It Takes Two", "Uncharted 4", "Lego Star Wars: The SkyWalker Saga", "Overcooked","Portal 2"
    ,"A Way Out", "Borderland 3"};
    char nama_diskon_horror[10][99]={"Prey","Nope","X","The Hereditary","The Conjuring",
