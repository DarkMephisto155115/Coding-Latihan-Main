...
struct data_list_game // Menyimpan data list game S4
{
    ...
    char list_game[30][50] = {"Red Dead Redemption 2", "Grand Theft Auto V", "The Last Of Us Remastered","God Of War", "The last Of Us Part 2","Persona 5 Royal",
                            "Metal Geat Solid V", "Uncharted 4", "Journey", "Bloodborne", "Undertale", "The Witcher 3", "Divinity Original Sin 2", "Shadow Of The Colossus", "Celeste",
                            "Inside", "Nier Automata", "Resident Evil 2", "Dragon Quest XI", "Diablo 3", "Shovel Knight", "Reyman Legends", "Fez", "Monster Hunter World: Iceborne",
                            "Sekiro: Shadow Die Twice", "Titan Fall 2", "Elden Ring", "Dark Soul III", "Demon Soul", "It Takes Two"    }
};
...
void diskon_spesial()
{
    ...
    char nama_diskon_multiplayer[10][50] = {"Divinity Original Sin 2", "Diablo 3", "Shovel Knight",
                                            "It Takes Two", "Uncharted 4", "Lego Star Wars: The SkyWalker Saga", "Overcooked", "Portal 2", "A Way Out", "Borderland 3"};
    char nama_diskon_horror[10][50] = {"Prey", "Nope", "X", "The Excorcist", "The Hereditary", "The Conjuring",
